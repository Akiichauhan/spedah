...
class BarChartSample4 extends StatefulWidget {
  ...
  final Color dark = AppColors.PrimaryColor;
  final Color normal = AppColors.drawerbgcolor;
  final Color light = AppColors.blackColor;
...
class BarChartSample4State extends State<BarChartSample4> {
  Widget bottomTitles(double value, TitleMeta meta) {
    // aaya const hatu to me var lidhu che
